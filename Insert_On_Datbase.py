    ...
    while a == 0:
        try:
            ...
            string_Translate_Table = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\">" +\
                        ...
                        "<tr bgcolor=\"#e8eff1\" onmouseover=\"this.style.backgroundColor='#d6edf5'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">NIT No </td><td style=\"padding:7px;\">" + SegFeild[13] + "</td></tr>" + \
            ...
            Final_Doc = "<HTML><BODY><style style=\"text/css\"> td{ padding:5px;}</style>" + string_Translate_Table + "<BR><BR><font color='RED'>[Disclaimer: The above text is machine translated. For accurate information kindly refer the below original document.]</font><BR><BR>" + get_htmlSource + \
                        "<br><a href="+SegFeild[28]+" target=\"_blank\"><h3 style=\"color:red;\"> If Attachment's Is Not Downloading Then Click Here And Search By <strong> NIT No </strong> Given Above  <h3></a></Blockquote></BODY></HTML>"
            Final_HTML_Document = "<head><meta content=\"text/html; charset=utf-8\" http-equiv=\"Content-Type\" /><title>Tender Document</title><Blockquote style='border:1px solid; padding:10px;'>" + Final_Doc + "</Blockquote>"
...
def insert_L2L(SegFeild , Fileid):
    ...
    Col1 = 'https://ppms.pprasindh.gov.pk/'
    if SegFeild[7] == "IN":
